...
export async function shareFileService(
  ...
  result = await db.one(
      `INSERT INTO user_access (encrypted_file_key, file_id, user_id, encrypted_manifest_key, share_duration)
                VALUES ($1, $2, $3, $4, $5)
                RETURNING access_id`,
        [encrypted_file_key, file_id, recipient_id, encrypted_manifest_key, share_period]
  );
